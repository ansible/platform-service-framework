...
class APIRootView(APIView):
    ...
    def get(self, request):
        ...
        self._extract_patterns(resolver.url_patterns, '', endpoints, request, prefix, current_url_name)

        # Sort alphabetically for consistent output
        return Response(dict(sorted(endpoints.items())))

    def _extract_patterns(self, patterns, current_path, endpoints, request, prefix, exclude_name=None):
            ...
            if hasattr(pattern, 'url_patterns'):
                ...
                if full_path.startswith(prefix):
                    ...
                    if relative_path and relative_path != '/':
                        ...
                        if len(path_parts) == 1 and '<' not in relative_path and '^' not in relative_path:
                ...
                self._extract_patterns(pattern.url_patterns, full_path, endpoints, request, prefix, exclude_name)
